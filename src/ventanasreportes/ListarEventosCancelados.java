...
public class ListarEventosCancelados extends JPanel {
    
    //Objetos/Atributos.
    public JButton botonRegresar = new JButton("REGRESAR");
    public JLabel titulo = new JLabel("EVENTOS CANCELADOS");
    ...
    public ListarEventosCancelados(){
        ...
        botonRegresar.setBounds(50, 600, 180, 50);
        add(botonRegresar);
        
        //Título de la ventana.
        titulo.setFont(fuenteTitulo);
        titulo.setForeground(Color.ORANGE);
        titulo.setBounds(245, 20, 400, 100);
        add(titulo);
